...
// Don't allways call document.getElementById inside the loop
...
//runs requestAnimationFrame with updatePositions on scroll to allows the browser to run
//the  event handler when it is free to do new paint work on the screen.
// not a big performance boost compared to: window.addEventListener('scroll', updatePositions);
...
// On a full hd screen 32 pizzas are enough to display 8
